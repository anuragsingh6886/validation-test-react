...
const HeroBanner = () => {
  return (
    <div className="pt-16 md:my-10">
      <div class="pt-16 w-full p-4 flex flex-col items-center text-center bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
